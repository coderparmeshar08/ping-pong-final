...
function move() {
  fill(50, 350, 0);//green color 
  stroke(255, 0, 0);//red cocor
  strokeWeight(0.5);
  ellipse(ball.x, ball.y, ball.r, 20)//draw a circle
  ...
  if (pcscore == 4) {
    ...
    text("Press restart button to play the game again.", width / 2, height / 2 + 30)
    noLoop();
    pcscore = 0;
  }
...
function preload() {
  missed_ball = loadSound("missed.wav");
	touched_ball = loadSound("ball_touch_paddel.wav");
}
